    ...
    return (
        ...
        <div className="singlePost">
            <div className="singlePostWrapper">
                ...
                />{editState ? <textArea onChange={(e)=>{setTitleEdit(e.target.value)}}>{postState.title}</textArea> :
                <h1 className="singlePostTitle">
                    {postState.title}
                <div className="singlePostEdit">
                    <i className="singlePostIcon far fa-edit" onClick={(e)=>{setEditState(true)}}></i>
                ...
                {editState ? <div><textarea onChange={(e)=>{setContentEdit(e.target.value)}}>{postState.content}</textarea><button onClick={(e)=>{setEditState(false)}}>Submit Changes</button> </div> :
